...
if(isset($_POST['register'])){
    ...
    $sql = "INSERT INTO `users` (`first-name`, `last-name`, `password`, `country`, `email`, `phone-no`) VALUES ('$firstname','$lastname','$password','$country','$email','$phoneno')";
                    ...
                    <div class="card ">
                        ...
                        <form method="POST" class="mt-5 card__form">
                            ...
                            <div class="form-group ">
                                ...
                                <input type="mumber" class="form-control" name="phone_no" value="" id="phone" placeholder="Enter Phone number">
                            </div>
                            <div class="form-row">
                                                                <div class="form-group col-md-6">
